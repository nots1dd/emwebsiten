...
enum class ShaderID : std::size_t
{
  ...
  projects_lava_inv,
  ultra,
  scan_wipe_transition,
  datamosh_transition,
  power_off_transition,
  crt_static_transition,
  wave_dissolve_transition,
  blog_pixel,
  blog_pixel_inv,
...
constexpr auto shader_registry = std::to_array<ShaderDesc>({
  ...
  {.id   = ShaderID::scan_wipe_transition,
   .name = "scan_wipe_transition",
   .vert = "/assets/shaders/fullscreen.vert",
   .frag = "/assets/shaders/scan-wipe.transition.glsl"},
  {.id   = ShaderID::datamosh_transition,
   .name = "datamosh_transition",
   .vert = "/assets/shaders/fullscreen.vert",
   .frag = "/assets/shaders/datamosh.transition.glsl"},
  {.id   = ShaderID::power_off_transition,
   .name = "power_off_transition",
   .vert = "/assets/shaders/fullscreen.vert",
   .frag = "/assets/shaders/power-off.transition.glsl"},
  {.id   = ShaderID::crt_static_transition,
   .name = "crt_static_transition",
   .vert = "/assets/shaders/fullscreen.vert",
   .frag = "/assets/shaders/crt-static.transition.glsl"},
  {.id   = ShaderID::wave_dissolve_transition,
   .name = "wave_dissolve_transition",
   .vert = "/assets/shaders/fullscreen.vert",
   .frag = "/assets/shaders/wave-dissolve.transition.glsl"},
