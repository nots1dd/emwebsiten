  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        lang: "C++",
        date: "2025",
        about: "A local networking solution for audio streaming and sharing, supporting lossless and lossy audio formats through a unified platform, written in C++20.\nWavy is a lightweight and efficient solution for audio streaming within a local network. It is designed to encode, decode, and dispatch audio streams seamlessly while ensuring secure data transfer via SSL/TLS encryption.",
        tags: ["audio", "libav", "audio-streaming", "zstd", "adaptive-bitrate", "boost-libraries", "openssl", "mp3/flac"],
        images: [],
      },
      {
        title: "obZcene",
        ...
        lang: "C",
        date: "2025",
        about: "Possibly a super small but very powerful Immediate mode game engine. Very much in early stages and actually is in the process of a rewrite coz I write bad graphics code.",
      ...
      },
      {
        ...
        lang: "C",
        date: "2024",
        about: "AV with a custom written FFT for cooler sample visualization.",
