...
.PHONY: \
	...
	ccache-stats help \
	website-run website-stop website-status website-logs
...
help:
	...
	@echo ""
	@echo -e "$(COLOR_BOLD)Build Targets$(COLOR_RESET)"
	@echo -e "  $(COLOR_CYAN)build$(COLOR_RESET)            Build existing Release configuration"
	@echo -e "  $(COLOR_CYAN)buildx$(COLOR_RESET)           Configure + build Release"
	@echo -e "  $(COLOR_CYAN)rebuild$(COLOR_RESET)          Clean + rebuild Release"
	@echo ""
	@echo -e "  $(COLOR_CYAN)build-dbg$(COLOR_RESET)        Build existing Debug configuration"
	@echo -e "  $(COLOR_CYAN)buildx-dbg$(COLOR_RESET)       Configure + build Debug (ASAN enabled)"
	@echo -e "  $(COLOR_CYAN)rebuild-dbg$(COLOR_RESET)      Clean + rebuild Debug"
	@echo ""
	@echo -e "$(COLOR_BOLD)Run Targets$(COLOR_RESET)"
	@echo -e "  $(COLOR_CYAN)run$(COLOR_RESET)              Run Release binary"
	@echo -e "  $(COLOR_CYAN)run-dbg$(COLOR_RESET)          Run Debug binary"
	@echo ""
	@echo -e "$(COLOR_BOLD)Testing$(COLOR_RESET)"
	@echo -e "  $(COLOR_CYAN)test$(COLOR_RESET)             Run Release tests"
	@echo -e "  $(COLOR_CYAN)test-dbg$(COLOR_RESET)         Run Debug tests"
	@echo ""
	@echo -e "$(COLOR_BOLD)Code Quality$(COLOR_RESET)"
	@echo -e "  $(COLOR_CYAN)fmt$(COLOR_RESET)              Format source files"
	@echo -e "  $(COLOR_CYAN)fmt-check$(COLOR_RESET)        Verify formatting"
	...
	@echo -e "  $(COLOR_CYAN)verify-deps$(COLOR_RESET)      Check required tools"
	@echo -e "  $(COLOR_CYAN)ccache-stats$(COLOR_RESET)     Show ccache statistics"
	@echo -e "  $(COLOR_CYAN)clean$(COLOR_RESET)            Remove build directories"
	@echo ""
	@echo -e "$(COLOR_BOLD)Website$(COLOR_RESET)"
	@echo -e "  $(COLOR_CYAN)website-run$(COLOR_RESET)      Start local website deployment"
	@echo -e "  $(COLOR_CYAN)website-stop$(COLOR_RESET)     Stop local website deployment"
	@echo -e "  $(COLOR_CYAN)website-status$(COLOR_RESET)   Show deployment status"
	@echo -e "  $(COLOR_CYAN)website-logs$(COLOR_RESET)     Show deployment logs"
	@echo ""
